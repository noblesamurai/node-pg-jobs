...
module.exports = function(dbIn) {
  ...
  if (process.env.NODE_ENV == 'test') {
    Jobs.setJobs = function(db, newJobs, callback) {
      jobsModel.setJobs(db, newJobs, callback);
    };
    Jobs.getJobs = function(db, callback) {
      return jobsModel.getJobs(db, callback);
    };
    Jobs.getScheduledJobs = function(db, callback) {
      jobsModel.scheduledJobs(db, callback);
    };
    Jobs.removeAllJobs = function(db, callback) {
